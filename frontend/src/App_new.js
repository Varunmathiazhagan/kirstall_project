...
function App() {
  ...
  const renderCurrentPage = () => {
    switch(currentPage) {
      case 'dashboard':
        return <Dashboard token={token} user={currentUser} />;
      case 'purchases':
        return <Purchases token={token} user={currentUser} />;
      case 'transfers':
        return <Transfers token={token} user={currentUser} />;
      case 'assignments':
        return <AssignmentsExpenditures token={token} user={currentUser} />;
      default:
        return <Dashboard token={token} user={currentUser} />;
    }
  };
